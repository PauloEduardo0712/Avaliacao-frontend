...
export default function Dashboard() {
  ...
  const estoqueBaixo = produtos.filter((p) => p.quantidadeEstoque <= p.estoqueMinimo)
    ...
    <div>
      ...
      <div className="grid">
        ...
        <div className="card">
          ...
          <div className="stat">{Number(valorTotal).toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}</div>
        </div>
        <div className="card">
